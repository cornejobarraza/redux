...
function DropDown() {
  return (
    <Menu as="div" className="lg:hidden inline-block text-left">
      ...
      >
        <Menu.Items className="absolute right-6 top-14 w-32 z-20 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
            <Menu.Item>
              {({ active }) => (
                <span
